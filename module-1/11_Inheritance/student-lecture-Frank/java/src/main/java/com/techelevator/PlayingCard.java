...
public class PlayingCard {
	...
	// making the parameters the same name and the data members requires this. To be coded when reference data members.
	public PlayingCard(int value, String suit, String color) {
		...
		this.color = color;		// because the parameters have the same names as the data members
	}
