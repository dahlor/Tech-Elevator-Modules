...
public class Exercises {
	...
	public int max1020(int a, int b) {
		if (((a >= 10) && (a <= 20)) && ((b >= 10) && (b <= 20)) && (a >= b)) { // A Greater than / in range
			return a;
		}
		if (((a >= 10) && (a <= 20)) && ((b >= 10) && (b <= 20)) && (b >= a)) {// B Greater than / in range
		    return b;
		}
		if (((a >= 10) && (a <= 20)) && ((b <= 10) || (b >= 20))) { // A Greater than / out of range
			return a;
		}
		if (((a >= 10) && (a <= 20)) && ((b <= 10) || (b >= 20))) { // B Greater than / out of range
			return b;
		}	
			return 0;
		}
    ...
    public String yourCakeAndEatItToo(double mealAmount, boolean isBirthday) {
        if ((mealAmount > 10) && (isBirthday == true)) {
        		return "ginormous";
    	}
        else if ((mealAmount > 15) && (isBirthday == false)) {
        		return "ginormous";
		}
        else if ((mealAmount >= 6) && (mealAmount <= 10) && (isBirthday == true)) {
        		return "special";
        }
        else if ((mealAmount >= 10.01) && (mealAmount <= 15) && (isBirthday == false)) {
        		return "special";
        }
        else if ((mealAmount <= 5) && (isBirthday == true)) {
        		return "standard";
        }
        return "standard";
    }
	...
	public String alarmClock(int day, boolean vacation) {
		...
		else if (((day == 1) || (day == 2) || (day == 3) || (day == 4) || (day == 5)) && (vacation == false)) {
				return "7:00";
		}
				return "10:00";		
	}
	...
	public int teaParty(int tea, int candy) {
		...
		else if (((tea >= 5) && (tea < (candy * 2))) && ((candy >= 5) && (candy < (tea * 2)))) {
			return 1;
		}
		return 0;
	}
