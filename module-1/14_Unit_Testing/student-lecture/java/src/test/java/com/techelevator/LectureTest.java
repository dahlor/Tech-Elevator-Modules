...
public class LectureTest {
	...
	@Before // Do this before every unit test - any setup required for each test - define and init vars, gather some data
	...
	@After	// Do this after every test - any takedown processing to be done after each test
	public void teardown() { // method name doesn't matter as long as its descriptive
		System.out.println("teardown"); // displays from a test - Not usually done - this is here for illustration purposes
	}
	 ...
	 *     - take no arguments
	 */
	@Test	// Identifies unit test to JUnit - if omitted, JUnit doesn't see the test
	public void length_returns_the_number_of_characters_in_a_String() {
		...
		Assert.assertEquals(4, length); // Assert - Check to see if the process did what whas expected
	}
