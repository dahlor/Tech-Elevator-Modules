...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		names.add("Frank");			// Add a String object to the top of the ArrayList
		names.add("Jason");			// Add a String to the ArrayList
		names.add("Sam");
		names.add("Avery");
		names.add("Daniel");
		names.add("D");
...
//		names.add(1);         		// Error because we are trying to add an int to an ArrayList of Strings
		...
		names.add(3, "Anne");		// Place "Anne" at index 3 and push elements down in the array.
		...
		// .indexOf(object) - return the index of the first occurrence 
		...
		// .toArray(new datatype[0]) - convert an ArrayList into an array of type specified and return array
		//
		// Convert the ArrayList<String> into a String[] (array of Strings)
		//
		
		String [] namesArray = names.toArray(new String[0]); // [0] to hole place the # of elements
		
		// Note: .length for an array does not have () - because length is a property of an array
		...
		//
		//		 Whenever you see a word, that it's not if or for or while, followed by (), it's method name
		...
		// Collections.sort(ArrayListName) - The Collections class provides a sort method that can
		//									 be used with any type of Collection class object
		
		Collections.sort(names);  // Use the Collections class sort() method to sort the ArrayList
								  // 	Since the datatype of the ArrayList is String, it will sort
								  //	alphabetically
		...
		//
		// for-each always goes from the beginning to the end of the array/ArrayList
		// 		Cannot start and stop anywhere
		...
		Collections.sort(names); // Put ArrayList back into alphabetical order
		
		//     curr-elem : arrayList
		for(String aName : names) {		// Similar to for(int i=0; i < names.size(); i++)
			System.out.println("Current element is: " + aName); // in a regular for-loop, we'd used names.get(i)
		}
	}
}
