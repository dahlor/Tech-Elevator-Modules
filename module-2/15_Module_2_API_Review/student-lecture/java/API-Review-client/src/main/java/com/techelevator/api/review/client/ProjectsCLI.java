...
public class ProjectsCLI {
	...
	public ProjectsCLI() {
		...
		dataSource.setUrl("jdbc:postgresql://localhost:5432/apireview"); //this has the name of the database we need to access
	...
	private void handleListAllDepartments() {
		...
		// List<Department> allDepartments = departmentDAO.getAllDepartments();
		RestTemplate callApi = new RestTemplate();	// Instantiate a RestTemplate object to manage our API calls
		...
		listDepartments(Arrays.asList(deptArray)); // Call the method to display with the Department array convert to a List
	}
